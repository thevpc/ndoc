...
public class NewProjectPanel extends JPanel {
    ...
    public NewProjectPanel(ServiceHelper serviceHelper) {
        ...
        add(new JLabel("Project Name"), NDocUIHelper.forLabel(0, 0));
        add(projectName = new JTextField(), NDocUIHelper.forEditor(1, 0));
        projectName.setText("new-project");

        add(new JLabel("Root Folder"), NDocUIHelper.forLabel(0, 1));
        add(rootFolder = new PathField(), NDocUIHelper.forEditor(1, 1));
