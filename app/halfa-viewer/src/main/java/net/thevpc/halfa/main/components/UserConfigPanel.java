...
import net.thevpc.halfa.config.UserConfigs;
...
public class UserConfigPanel extends JPanel {
    ...
    public UserConfigPanel(UserConfigs configs) {
        ...
        add(new JLabel("Profile"), HadraUIHelper.forLabel(0, row));
        add(profileId, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("Full Name"), HadraUIHelper.forLabel(0, row));
        add(fullName, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("Email"), HadraUIHelper.forLabel(0, row));
        add(emailAddress, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("Affiliation"), HadraUIHelper.forLabel(0, row));
        add(affiliation, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("Username"), HadraUIHelper.forLabel(0, row));
        add(username, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("First Name"), HadraUIHelper.forLabel(0, row));
        add(fistName, HadraUIHelper.forEditor(1, row));
        row++;

        add(new JLabel("Last Name"), HadraUIHelper.forLabel(0, row));
        add(lastName, HadraUIHelper.forEditor(1, row));
        row++;
