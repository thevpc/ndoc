...
public abstract class NDocNodeParserBase implements NDocNodeParser {
    ...
    public void onStartParsingItem(String id, NTxNode p, NElement element, NDocNodeFactoryParseContext context) {
...
//                NDocObjEx ee = NDocObjEx.of(element);
    ...
    protected NCallableSupport<NTxItem> _invalidSupport(NMsg msg, NDocNodeFactoryParseContext context) {
        msg = msg.asError();
