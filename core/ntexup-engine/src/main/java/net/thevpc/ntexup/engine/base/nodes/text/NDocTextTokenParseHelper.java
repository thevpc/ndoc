...
import net.thevpc.ntexup.api.renderer.text.NDocTextTokenText;
...
class NDocTextTokenParseHelper {
    ...
    public NDocTextTokenParseHelper(NDocNodeRendererContext ctx, NReservedSimpleCharQueue cq, NTxNodeCustomBuilderContext builderContext) {
        this.ctx = ctx;
        this.cq = cq;
