...
public class NDocNodeGridBagLayout {
    ...
    public NDocNodeGridBagLayout(Insets parentInsets, boolean rightToLeft, NTxBounds2 parentBounds, NDocNodeGridNode[] children) {
...
//        NDocNodeGridNodeExt comp;
     ...
     *                   ipady
     */
    private void alignOnBaseline(NDocNodeGridNodeExt cons, NTxEditableBounds2 r,
     ...
     */
    private void alignAboveBaseline(NDocNodeGridNodeExt cons, NTxEditableBounds2 r,
                                    double cellY, double cellHeight) {
     ...
     */
    private void alignBelowBaseline(NDocNodeGridNodeExt cons, NTxEditableBounds2 r,
                                    double cellY, double cellHeight) {
        if (layoutInfo.hasBaseline(cons.tempY)) {
            if (layoutInfo.hasConstantDescent(cons.tempY)) {
                // Prefer descent
    ...
    private void centerVertically(NDocNodeGridNodeExt cons, NTxEditableBounds2 r,
                                  double cellHeight) {
        if (!cons.isVerticallyResizable()) {
    ...
    private NTxSizeD getMinSize(NDocNodeGridBagLayoutInfo info) {
        double width = 0;
        double height = 0;
        int i, t;
    ...
    public static class NDocNodeGridNode implements Cloneable {
        ...
        public NDocNodeGridNode setPreferredSize(NTxSizeD preferredSize) {
        ...
        public NDocNodeGridNode setMinimumSize(NTxSizeD minimumSize) {
        ...
        public NDocNodeGridNode setBounds(NTxBounds2 bounds) {
            this.bounds = bounds;
            return this;
        }
