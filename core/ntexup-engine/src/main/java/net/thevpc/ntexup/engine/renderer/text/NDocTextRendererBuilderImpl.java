...
public class NDocTextRendererBuilderImpl implements NDocTextRendererBuilder {
    ...
    public void appendNText(String lang, String rawText, NText text, NTxNode node, NDocNodeRendererContext ctx) {
        NutsHighlighterMapper.highlightNutsText(lang, rawText, text, node, ctx, this);
    }

    @Override
    public void appendText(String rawText, NDocTextOptions options, NTxNode node, NDocNodeRendererContext ctx) {
    ...
    @Override
    public void appendCustom(String lang, String rawText, NDocTextOptions options, NTxNode node, NDocNodeRendererContext ctx) {
        if (rawText == null || rawText.isEmpty()) {
            return;
        }
