...
public class NDocGraphicsImpl implements NDocGraphics {
    ...
    public NDocGraphicsImpl(Graphics2D g, NTxEngine engine) {
        this.g = g;
        this.engine = engine;
    ...
    public NDocGraphicsImpl(Graphics2D g, NDocImageTypeRendererFactory[] factories, NTxEngine engine) {
        this.g = g;
        this.engine = engine;
    ...
    @Override
    public void drawArrayHead(NTxPoint2D origin, NTxVector2D direction, NDocArrow arrow) {
