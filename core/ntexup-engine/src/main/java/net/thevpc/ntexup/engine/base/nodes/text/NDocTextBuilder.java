...
public class NDocTextBuilder implements NDocNodeBuilder {
    ...
    public void buildText(String text, NDocTextOptions options, NTxNode p, NDocNodeRendererContext ctx, NDocTextRendererBuilder builder, NDocNodeCustomBuilderContext builderContext) {
