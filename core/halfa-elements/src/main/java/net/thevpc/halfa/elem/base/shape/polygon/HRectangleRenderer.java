            ...
            if (!round && !d3) {
                ...
                if (HNodeRendererUtils.applyForeground(p, g, ctx, !someBG)) {
                    HNodeRendererUtils.withStroke(p, g, ctx, () -> {
                        g.drawRect((int) x, (int) y, net.thevpc.halfa.api.util.HUtils.intOf(b.getWidth()), net.thevpc.halfa.api.util.HUtils.intOf(b.getHeight()));
                    });
                }
            } else if (round) {
                double cx = net.thevpc.halfa.api.util.HUtils.doubleOf(roundCorners.getX()) / 100 * ctx.getGlobalBounds().getWidth();
                double cy = net.thevpc.halfa.api.util.HUtils.doubleOf(roundCorners.getY()) / 100 * ctx.getGlobalBounds().getHeight();
                boolean someBG = false;
                if (someBG = HNodeRendererUtils.applyBackgroundColor(p, g, ctx)) {
                    g.fillRoundRect((int) x, (int) y, net.thevpc.halfa.api.util.HUtils.intOf(b.getWidth()), net.thevpc.halfa.api.util.HUtils.intOf(b.getHeight()), (int) cx, (int) cy);
                }
                if (HNodeRendererUtils.applyForeground(p, g, ctx, !someBG)) {
                    HNodeRendererUtils.withStroke(p, g, ctx, () -> {
                        g.drawRoundRect((int) x, (int) y, net.thevpc.halfa.api.util.HUtils.intOf(b.getWidth()), net.thevpc.halfa.api.util.HUtils.intOf(b.getHeight()), (int) cx, (int) cy);
                    });
                }
            } else if (threeD) {
                boolean someBG = false;
                if (someBG = HNodeRendererUtils.applyBackgroundColor(p, g, ctx)) {
                    g.fill3DRect((int) x, (int) y, net.thevpc.halfa.api.util.HUtils.intOf(b.getWidth()), net.thevpc.halfa.api.util.HUtils.intOf(b.getHeight()), raised != null && raised);
                }
                if (HNodeRendererUtils.applyForeground(p, g, ctx, !someBG)) {
                    HNodeRendererUtils.withStroke(p, g, ctx, () -> {
                        g.draw3DRect((int) x, (int) y, net.thevpc.halfa.api.util.HUtils.intOf(b.getWidth()), HUtils.intOf(b.getHeight()), raised != null && raised);
                    });
                }
            }
        }
