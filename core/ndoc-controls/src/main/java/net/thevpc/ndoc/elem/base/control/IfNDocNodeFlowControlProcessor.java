...
public class IfNDocNodeFlowControlProcessor implements NDocNodeFlowControlProcessor {
    @Override
    public HNode[] process(HNode hNode, NDocNodeFlowControlProcessorContext context) {
    ...
    private HNode[] processIfElse(HNode hNode, NDocNodeFlowControlProcessorContext context) {
    ...
    private void processEvalVars(HNode hNode, NDocNodeFlowControlProcessorContext context) {
    ...
    private void processChildren(HNode[] newNodes, NDocNodeFlowControlProcessorContext context) {
