package net.thevpc.halfa.engine.nodes.elem2d.shape.polyline;
...
public class HPolylineImpl extends HNodeParserBase {
    ...
    public TsonElement toTson(HNode item) {
        ...
        if (points != null) {
            if (points instanceof Object[] && ((Object[]) points).length == 0) {
                points = null;
            }
        }
