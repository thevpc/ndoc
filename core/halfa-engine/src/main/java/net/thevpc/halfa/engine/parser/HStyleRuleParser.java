...
//                                    if (!u.isPresent()) {
//                                        return NOptional.ofEmpty(s-> NMsg.ofC("invalid invalid style rule  %s :: %s",e, u.getMessage().apply(s)));
//                                    }
//                                    styles.add(u.get());
//                                }
//                                break;
...
//    }
    ...
    public static List<HStyle> toHStyleList(List<HItem> i){
