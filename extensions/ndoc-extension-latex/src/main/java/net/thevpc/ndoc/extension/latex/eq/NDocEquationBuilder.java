 ...
 * @author vpc
 */
public class NDocEquationBuilder extends NDocNodeParserBase {

    public NDocEquationBuilder() {
    ...
    protected boolean processArgument(ParseArgumentInfo info) {
        switch (info.getCurrentArg().type()) {
            ...
            case LINE_STRING:
            {
                info.getNode().setProperty(NDocProp.ofString(NDocPropName.VALUE, info.getCurrentArg().asStringValue().get()));
                return true;
            }
        }
