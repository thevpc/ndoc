                ...
                .add(f.page()
                                .add(
                                        f.grid(3,2)
                                                ...
                                                .add(
                                                        f.rectangle().set(HStyles.backgroundColor(Color.RED))
                                                                .set(HStyles.rowspan(4))
                                                )
                                                .add(f.grid(4,4)
                                                        .set(HStyles.colspan(3))
                                                        .set(HStyles.rowspan(2))
                                                .add(f.rectangle().set(HStyles.backgroundColor(Color.BLUE))
                                                        .set(HStyles.colspan(5))
                                                        .set(HStyles.rowspan(2))
                                                )
                                                .add(f.rectangle().set(HStyles.backgroundColor(Color.RED)))
                                                .add(f.rectangle().set(HStyles.backgroundColor(Color.GREEN)))
                                                .add(f.rectangle().set(HStyles.backgroundColor(Color.YELLOW))))
                                )
                )
//                .add(f.page()
//                                .add(
